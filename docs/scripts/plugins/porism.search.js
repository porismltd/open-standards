(function () {
  ...
  function tpl(opts, defaultValue) {
    ...
    var el = Docsify.dom.create('div');
    el.setAttribute('class', 'results-panel');
    var form = Docsify.dom.find('body > header form');

    Docsify.dom.before(form, el);
  }



  function doSearch(value) {
    var $search = Docsify.dom.find('body > header form');
  ...
  function bindEvents() {
    ...
    Docsify.dom.on(window, 'click', function (e) {
  ...
  function hide() {
    var $search = Docsify.dom.find('body > header form');
    var $panel = Docsify.dom.find($search, '.results-panel');
    Docsify.dom.toggleClass($panel, 'remove', 'show');
  }

  function show() {
    var $search = Docsify.dom.find('body > header form');
    var $panel = Docsify.dom.find($search, '.results-panel');
    Docsify.dom.toggleClass($panel, 'add', 'show');
  }
  ...
  var install = function (hook, vm) {
    ...
    hook.ready(function () {
      ...
      query = Docsify.util.parseQuery(query);
