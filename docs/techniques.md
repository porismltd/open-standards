...
**[IN OUR EXPERIENCE.]** Because SDMX is so generic, the LGA chose a model with three fixed dimensions that always apply to the metrics data that drives its reporting tool.
